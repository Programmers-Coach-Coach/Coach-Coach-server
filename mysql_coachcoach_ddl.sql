...
CREATE TABLE `actions` (
  ...
  `action_name` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `count` int DEFAULT NULL,
  `set` int DEFAULT NULL,
  `minutes` int DEFAULT NULL,
  `description` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`action_id`),
  KEY `fk_actions_routine_category_id_idx` (`routine_category_id`),
...
CREATE TABLE `coaches` (
  ...
  `coach_introduction` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `created_at` timestamp NOT NULL,
  `active_center` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `active_hours_on` int DEFAULT NULL,
  `active_hours_off` int DEFAULT NULL,
  `chatting_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `coaching_sports`
--

LOCK TABLES `coaching_sports` WRITE;
/*!40000 ALTER TABLE `coaching_sports` DISABLE KEYS */;
/*!40000 ALTER TABLE `coaching_sports` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `completed_categories` (
  ...
  `routines_category_id` int NOT NULL,
  PRIMARY KEY (`completed_category_id`),
  KEY `fk_completed_categories_user_record_id` (`user_record_id`),
  KEY `fk_completed_categories_routines_category_id` (`routines_category_id`),
  CONSTRAINT `fk_completed_categories_routines_category_id` FOREIGN KEY (`routines_category_id`) REFERENCES `routine_categories` (`routine_category_id`),
  CONSTRAINT `fk_completed_categories_user_record_id` FOREIGN KEY (`user_record_id`) REFERENCES `user_records` (`user_record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='완료 카테고리';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `completed_categories`
--

LOCK TABLES `completed_categories` WRITE;
/*!40000 ALTER TABLE `completed_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `completed_categories` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `interested_sports` (
  `idinterested_sports_id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `sports_id` int NOT NULL,
  PRIMARY KEY (`idinterested_sports_id`),
  KEY `fk_interested_sports_user_id` (`user_id`),
  KEY `fk_interested_sports_sports_id` (`sports_id`),
...
--
-- Dumping data for table `interested_sports`
--

LOCK TABLES `interested_sports` WRITE;
/*!40000 ALTER TABLE `interested_sports` DISABLE KEYS */;
/*!40000 ALTER TABLE `interested_sports` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `notifications` (
  ...
  `user_id` int NOT NULL,
  `message` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `is_reading` tinyint NOT NULL,
  `relation_function` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `created_at` timestamp NOT NULL,
...
CREATE TABLE `routine_categories` (
  ...
  KEY `fk_routine_categories_routine_id_idx` (`routine_id`),
...
--
-- Dumping data for table `routine_categories`
--

LOCK TABLES `routine_categories` WRITE;
/*!40000 ALTER TABLE `routine_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `routine_categories` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `routines` (
  ...
  `sports_id` int NOT NULL,
  `routine_name` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`routine_id`),
  KEY `fk_routines_user_id_idx` (`user_id`),
  KEY `fk_routines_sports_id_idx` (`sports_id`),
  KEY `fk_routines_coach_id_idx` (`coach_id`),
...
CREATE TABLE `sports` (
  ...
  `sports_name` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `user_coach_likes` (
  `user_coach_likes_id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `coach_id` int NOT NULL,
  PRIMARY KEY (`user_coach_likes_id`),
...
--
-- Dumping data for table `user_coach_likes`
--

LOCK TABLES `user_coach_likes` WRITE;
/*!40000 ALTER TABLE `user_coach_likes` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_coach_likes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `user_coach_matching`
--

LOCK TABLES `user_coach_matching` WRITE;
/*!40000 ALTER TABLE `user_coach_matching` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_coach_matching` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users` (
  ...
  `salt` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `profile_image_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `gender` enum('M','W') CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `local_info` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
-- Dump completed on 2024-07-27 10:52:51
